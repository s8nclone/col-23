  ...
  return (
    <section 
        className="bg-[#F6F5F5] h-full flex flex-col bg-cover bg-no-repeat 
                sm:bg-feature-pattern px-8 sm:px-32 py-[3rem] sm:py-[6.5rem] gap-[7.5rem] "
    >
        ...
        <div className="flex flex-col shadow-xl sm:shadow-none rounded-2xl sm:rounded-none mx-2 px-2 sm:px-0 sm:mx-0 sm:flex-row items-center gap-6 sm:justify-between py-8">
            <Image
                src={feature1}
                alt="feature image"
            ...
            <div className="flex flex-col justify-center sm:w-[35rem] gap-4 sm:gap-6 text-[#3A3A3A] ">
                <h3 className="text-3xl sm:text-6xl font-medium ">Collaborate</h3>
        ...
        <div className="flex flex-col shadow-xl sm:shadow-none rounded-2xl sm:rounded-none mx-2 px-2 sm:px-0 sm:mx-0 sm:flex-row-reverse items-center gap-6 sm:justify-between py-8">
            <Image
                src={feature2}
                alt="feature image"
            ...
            <div className="flex flex-col justify-center sm:w-[35rem] gap-4 sm:gap-6 text-[#3A3A3A] ">
                <h3 className="text-3xl sm:text-6xl font-medium ">AI Pairing</h3>
                <p className="text-lg sm:text-2xl ">We will help you connect, learn and interact with your peers from any part of the world. </p>
                <Button btnText="Read More" />
            </div>
        ...
        <div className="flex flex-col shadow-xl sm:shadow-none rounded-2xl sm:rounded-none mx-2 px-2 sm:px-0 sm:mx-0 sm:flex-row items-center gap-6 sm:justify-between py-8">
            ...
            <div className="flex flex-col justify-center sm:w-[35rem] gap-4 sm:gap-6 text-[#3A3A3A] ">
                <h3 className="text-3xl sm:text-6xl font-medium ">Feedback</h3>
                <p className="text-lg sm:text-2xl ">We will help you connect, learn and interact with your peers from any part of the world. </p>
                <Button btnText="Read More" />
            </div>
        </div>
